        ...
        <div class="wrap mce-admin-page">
            ...
            <div class="mce-help-section">
                ...
                <ul>
                    ...
                    <li><?php echo esc_html(__('Sistema de caché inteligente para optimizar el rendimiento.', 'mi-conexion-externa')); ?></li>
                    <li><strong><?php echo esc_html(__('🛠️ Herramientas de Debug Avanzadas (¡NUEVO v2.0.0!)', 'mi-conexion-externa')); ?></strong></li>
            ...
            <div class="mce-help-section">
                ...
                <ul>
                    ...
                    <li><strong>columnas</strong>: <em>(Opcional)</em> <?php echo esc_html(__('Número MÁXIMO de columnas en pantallas grandes (1-6). En tablets y móviles se adapta automáticamente.', 'mi-conexion-externa')); ?> (<?php echo esc_html__('Defecto: 3', 'mi-conexion-externa') ?>)</li>
            ...
            <div class="mce-help-section">
                <h2><?php echo esc_html(__('Herramientas de Debug Avanzadas (¡NUEVO v2.0.0!)', 'mi-conexion-externa')); ?></h2>
                <p><?php echo esc_html(__('La versión 2.0.0 incluye herramientas avanzadas para diagnosticar problemas de conexión y consulta:', 'mi-conexion-externa')); ?></p>
                <ul>
                    <li><?php echo esc_html(__('🔗 Prueba de Conexión: Verifica la conectividad con la base de datos externa.', 'mi-conexion-externa')); ?></li>
                    <li><?php echo esc_html(__('📋 Listado de Tablas: Muestra todas las tablas disponibles en la DB externa.', 'mi-conexion-externa')); ?></li>
                    <li><?php echo esc_html(__('⚡ Ejecutor de Consultas: Permite ejecutar consultas SELECT personalizadas de forma segura.', 'mi-conexion-externa')); ?></li>
                    <li><?php echo esc_html(__('📊 Resultados en Tiempo Real: Feedback inmediato de todas las operaciones de diagnóstico.', 'mi-conexion-externa')); ?></li>
                </ul>
                <p><?php echo esc_html(__('Accede a estas herramientas desde la sección "Caché" en el menú de administración.', 'mi-conexion-externa')); ?></p>
            </div>

            <div class="mce-help-section">
                <h2><?php echo esc_html(__('📱 Diseño Completamente Responsive (¡NUEVO v2.1.0!)', 'mi-conexion-externa')); ?></h2>
                <p><?php echo esc_html(__('La versión 2.1.0 introduce un sistema de diseño completamente responsive que adapta automáticamente el número de columnas según el dispositivo:', 'mi-conexion-externa')); ?></p>
                
                <h4><?php echo esc_html(__('Adaptación Automática por Dispositivo', 'mi-conexion-externa')); ?></h4>
                <ul>
                    <li><strong>🖥️ Desktop (> 1024px):</strong> <?php echo esc_html(__('Muestra el número máximo de columnas especificado en el shortcode (ej. 3 columnas).', 'mi-conexion-externa')); ?></li>
                    <li><strong>📱 Tablet (768px - 1024px):</strong> <?php echo esc_html(__('Se adapta automáticamente, mostrando 2-3 columnas según el espacio disponible.', 'mi-conexion-externa')); ?></li>
                    <li><strong>📱 Móvil (< 768px):</strong> <?php echo esc_html(__('Muestra 1 columna para máxima legibilidad en smartphones.', 'mi-conexion-externa')); ?></li>
                </ul>

                <h4><?php echo esc_html(__('Características del Sistema Responsive', 'mi-conexion-externa')); ?></h4>
                <ul>
                    <li>✅ <?php echo esc_html(__('Adaptación automática sin necesidad de configuración adicional', 'mi-conexion-externa')); ?></li>
                    <li>✅ <?php echo esc_html(__('El parámetro "columnas" ahora define el MÁXIMO de columnas en pantallas grandes', 'mi-conexion-externa')); ?></li>
                    <li>✅ <?php echo esc_html(__('Ancho mínimo de tarjetas de 280px para garantizar legibilidad', 'mi-conexion-externa')); ?></li>
                    <li>✅ <?php echo esc_html(__('Distribución inteligente del espacio disponible', 'mi-conexion-externa')); ?></li>
                    <li>✅ <?php echo esc_html(__('Compatible con todos los navegadores modernos', 'mi-conexion-externa')); ?></li>
                    <li>✅ <?php echo esc_html(__('No requiere JavaScript adicional - usa CSS Grid moderno', 'mi-conexion-externa')); ?></li>
                    <li>✅ <?php echo esc_html(__('Retrocompatible - todos los shortcodes existentes funcionan automáticamente', 'mi-conexion-externa')); ?></li>
                </ul>

                <h4><?php echo esc_html(__('Ejemplo Práctico', 'mi-conexion-externa')); ?></h4>
                <p><?php echo esc_html(__('Con este shortcode:', 'mi-conexion-externa')); ?></p>
                <pre><code>[mce_mostrar_tabla tabla="gaceta_parlamentaria" columnas="3"]</code></pre>
                <p><?php echo esc_html(__('Obtendrás:', 'mi-conexion-externa')); ?></p>
                <ul>
                    <li><?php echo esc_html(__('En Desktop: 3 tarjetas por fila', 'mi-conexion-externa')); ?></li>
                    <li><?php echo esc_html(__('En Tablet: 2-3 tarjetas por fila (adaptativo)', 'mi-conexion-externa')); ?></li>
                    <li><?php echo esc_html(__('En Móvil: 1 tarjeta por fila (pantalla completa)', 'mi-conexion-externa')); ?></li>
                </ul>

                <p class="mce-notice"><?php echo esc_html(__('💡 Consejo: No necesitas modificar tus shortcodes existentes. El diseño responsive se aplica automáticamente a todos ellos.', 'mi-conexion-externa')); ?></p>
            </div>
            ...
            <div class="mce-help-section">
                ...
                <ul>
                    <li><strong><?php echo esc_html(__('Versión actual: v2.1.0', 'mi-conexion-externa')); ?></strong></li>
                    <li><strong><?php echo esc_html(__('📱 NUEVO: Diseño Completamente Responsive', 'mi-conexion-externa')); ?></strong></li>
                    <li><strong><?php echo esc_html(__('🎯 Grid adaptativo con CSS Grid Auto-Fit', 'mi-conexion-externa')); ?></strong></li>
                    <li><strong><?php echo esc_html(__('📐 Adaptación automática a móviles, tablets y desktop', 'mi-conexion-externa')); ?></strong></li>
                    <li><strong><?php echo esc_html(__('✨ Mejor experiencia en todos los dispositivos', 'mi-conexion-externa')); ?></strong></li>
                    <li><strong><?php echo esc_html(__('🛠️ Herramientas de Debug Avanzadas (v2.0.0)', 'mi-conexion-externa')); ?></strong></li>
                    <li><strong><?php echo esc_html(__('🔗 Prueba de conexión a base de datos externa', 'mi-conexion-externa')); ?></strong></li>
                    <li><strong><?php echo esc_html(__('📋 Listado automático de tablas disponibles', 'mi-conexion-externa')); ?></strong></li>
                    <li><strong><?php echo esc_html(__('⚡ Ejecutor seguro de consultas SELECT personalizadas', 'mi-conexion-externa')); ?></strong></li>
                    <li><?php echo esc_html(__('Corrección del menú de caché que no aparecía.', 'mi-conexion-externa')); ?></li>
                    <li><?php echo esc_html(__('🔥 Sistema de búsqueda y filtros AJAX en tiempo real (v1.2.0)', 'mi-conexion-externa')); ?></li>
